...
- **Tech Stack:** Python
- **Features:**
  - Implements Minimax with Alpha-Beta Pruning for optimization.
...
- **Features:**
  - Uses a pre-trained Vision Transformer (ViT) to analyze images.
...
- **Features:**
  ...
  - Customized Haar Cascade parameters to reduce false positives in complex backgrounds.
  - Draws dynamic bounding boxes around detected faces.
